...
*/
  ...
  illum_string[0] = zclApp_bh1750IlluminanceSensor_MeasuredValue / 10000 % 10 + '0';
  illum_string[1] = zclApp_bh1750IlluminanceSensor_MeasuredValue / 1000 % 10 + '0';
  illum_string[2] = zclApp_bh1750IlluminanceSensor_MeasuredValue / 100 % 10 + '0';
  illum_string[3] = zclApp_bh1750IlluminanceSensor_MeasuredValue / 10 % 10 + '0';
  illum_string[4] = zclApp_bh1750IlluminanceSensor_MeasuredValue % 10 + '0';
  ...
  temp_string[0] = zclApp_Temperature_Sensor_MeasuredValue / 1000 % 10 + '0';
  temp_string[1] = zclApp_Temperature_Sensor_MeasuredValue / 100 % 10 + '0';
  temp_string[3] = zclApp_Temperature_Sensor_MeasuredValue / 10 % 10 + '0';
  temp_string[4] = zclApp_Temperature_Sensor_MeasuredValue % 10 + '0';
  ...
  hum_string[0] = zclApp_HumiditySensor_MeasuredValue / 1000 % 10 + '0';
  hum_string[1] = zclApp_HumiditySensor_MeasuredValue / 100 % 10 + '0';
  hum_string[3] = zclApp_HumiditySensor_MeasuredValue / 10 % 10 + '0';
  hum_string[4] = zclApp_HumiditySensor_MeasuredValue % 10 + '0';
  ...
  pres_string[0] = zclApp_PressureSensor_MeasuredValue*10 / 10000 % 10 + '0';
  pres_string[1] = zclApp_PressureSensor_MeasuredValue*10 / 1000 % 10 + '0';
  pres_string[2] = zclApp_PressureSensor_MeasuredValue*10 / 100 % 10 + '0';
  pres_string[3] = zclApp_PressureSensor_MeasuredValue*10 / 10 % 10 + '0';
  pres_string[5] = zclApp_PressureSensor_MeasuredValue*10 % 10 + '0';
